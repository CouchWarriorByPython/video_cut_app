...
def convert_db_annotation_to_response(annotation: Dict[str, Any]) -> VideoAnnotationResponse:
    ...
    for clip_data in clips_data:
        ...
        if project_name not in clips:
            clips[project_name] = []
            cvat_params[project_name] = CVATProjectParamsResponse(**clip_data.get("task_params", {}))
    ...
    return VideoAnnotationResponse(
        ...
        filename=filename,
        created_at=annotation.get("created_at_utc", annotation.get("created_at", "")),
        updated_at=annotation.get("updated_at_utc", annotation.get("updated_at", "")),
