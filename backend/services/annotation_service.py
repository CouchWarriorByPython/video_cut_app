...
from backend.models.database import AzureFilePath, VideoAttributes
...
class AnnotationService:
    ...
    def _prepare_clips_for_processing(self, source_video_id: str, azure_path: AzureFilePath, clips: Dict[str, Any],
            ...
            for project_name, project_clips in clips.items():
                ...
                for clip_idx, clip in enumerate(project_clips):
                    ...
                    clip_data = {
                        ...
                        "video_attributes": VideoAttributes().model_dump(),
                        "frames_qty": None,
                        "annotation_statistics": None,
                        "azure_annotation_coco_path": None
                    }
    ...
    def _convert_to_api_format(self, annotation: Dict[str, Any]) -> Dict[str, Any]:
        ...
        for clip_data in clips_data:
            ...
            if project_name not in clips:
                clips[project_name] = []
                cvat_params[project_name] = clip_data.get("task_params", {})
